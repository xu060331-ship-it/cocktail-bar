...
export default function MakingLogForm({ cocktailEng, onSaved, initialLog = null, onCancel }) {
  const [form, setForm] = useState(() => initialLog ? { ...initialLog, brands: initialLog.brands?.join(", ") || "" } : { made_at: new Date().toISOString().slice(0, 10), brands: "", rating: 0, recipe_modified: false, modification_note: "", next_time_note: "" })
